...
?>
           <div class="sidebar">
            <ul style="list-style:none;">
                <li><img src="./assets/images/logo.png" class="logo" alt="Logo" width="100" height="100" style="position: relative; top:15px; left:70px;"></li>
                ...
                <li style=" padding:10px 40px;"><button class="sidebar_tweet button addTweetBtn" style="outline:none; background-color:#ea4545;">Tweet</button></li>
                <?php }?>
                ...
                <div class="media" style="margin-top:150px;">
                    <li class="media-inner">
                        <a href="<?php echo BASE_URL.$user->username; ?>">
                            <img src="./users/profile.png" width="50" height="50">
