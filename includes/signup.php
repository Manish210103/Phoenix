...
if(isset($_POST['next'])){
  ...
  <html>
  	<head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="./users/logo1.png">
  	</head>
  	<!--Helvetica Neue-->
  <body>
  <div class="wrapper">
  ...
  <div class="nav-wrapper">
  	...
  	<div class="nav-container">
  		<div class="nav-second">
			<div>
				<img src="./users/logo1.png" alt="Logo" width="100" height="100" style="position: relative; top:15px; right:10px;">
			</div>
		</div><!-- nav second ends-->
   		...
   		<div class="step-wrapper">
  		    <div class="step-container">
  				<form method="post" autocomplete="off">
  					...
  					<div>
  						<input type="submit" name="next" value="Next" style="background-color:#f2241d; color: white;"/>
  					</div>
  				 </form>
  			</div>
  		</div>
    ...
    <?php if ($_GET['step'] == '2'){?>
  	<div class='lets-wrapper'>
  		<div class='step-letsgo'>
  			...
  			<p style="font-size:22px;">Phoneix is a constantly updating stream of the coolest, most important news, media, sports, TV, conversations and more--all tailored just for you.</p>
  			<br>
  			<p style="font-size:22px;">
  				Tell us about all the stuff you love and we'll help you get set up.
  			</p>
  			<span>
  				<a href='../home.php' class='backButton' style="color:red;">Let's go!</a>
  			</span>
  		</div>
  	</div>
  <?php } ?>
